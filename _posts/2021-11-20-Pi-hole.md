...
<p align="center">
  <img src="https://github.com/aaas24/code_library/raw/main/pihole/images/imager_1.6.2.jpg" alt="RaspberryPi Imager Application" width="600">
</p>
...
<p align="center">
  <img src="https://github.com/aaas24/code_library/raw/main/pihole/images/pihole_installation.jpg" width="600" title="Pihole Installer">
</p>


During the installation it requires to select a Upstream DNS Provider. We selected "Clodflare (DNSSEC)". We prefer this provider because it favors speed and privacy. You can read more about it [here](https://1.1.1.1/dns/). For all other options during the configuration, we chose default values. These options included Web Interface (On), Web Server (On) and Logging (On) among others.
...
<p align="center">
  <img src="https://github.com/aaas24/code_library/raw/main/pihole/images/final-set-up-screen.jpg" width="600" title="Final Set Up Screen">
</p>
...
As a last resort, you can manually set each device to use Pi-hole as their DNS server.
 ...
 Here is a cool video on Youtube  that walks through some examples at the end by manually updating the DNS server in a TV, iphone and PC. 

[![Watch the video](https://github.com/aaas24/code_library/raw/main/pihole/images/youtube.png)](https://www.youtube.com/watch?v=KBXTnrD_Zs4)
...
<p align="center">
  <img src="https://github.com/aaas24/code_library/raw/main/pihole/images/configure_unify_step1.jpg" width="600" title="Set Up">
</p>
...
<p align="center">
  <img src="https://github.com/aaas24/code_library/raw/main/pihole/images/configure_unify_step2.jpg" width="600" title="Set Up">
</p>
...
<p align="center">
  <img src="https://github.com/aaas24/code_library/raw/main/pihole/images/configure_unify_step4.jpg" width="600" title="Set Up">
</p>
...
<p align="center">
  <img src="https://github.com/aaas24/code_library/raw/main/pihole/images/configure_unify_step5.jpg" width="600" title="Set Up">
</p>
...
<p align="center">
  <img src="https://github.com/aaas24/code_library/raw/main/pihole/images/web-console.jpg" alt="Web Console" width="600">
</p>
